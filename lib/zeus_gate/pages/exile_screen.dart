...
/// No-internet screen with Zeus-themed artwork and gold Retry button.
class ExileScreen extends StatefulWidget {
  final WidgetBuilder retryBuilder;
  final OlympusProbe probe;

  const ExileScreen({super.key, required this.retryBuilder, required this.probe});

  @override
  State<ExileScreen> createState() => _ExileScreenState();
}

class _ExileScreenState extends State<ExileScreen>
                    ...
                    child: AspectRatio(
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          ...
                          color: _busy ? const Color(0xFFFFD700).withValues(alpha: 0.3) : null,
                        ...
                        child: Center(
                          child: _busy
                              ...
                              : const Row(
                                  ...
                                  children: [
                                    Icon(Icons.refresh_rounded, color: Color(0xFF1A0A00), size: 26),
                                    SizedBox(width: 8),
                                    Text('Retry',
                                        style: TextStyle(
